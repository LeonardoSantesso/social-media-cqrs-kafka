...
namespace Post.Query.Infrastructure.Dispatchers
{
    public class QueryDispatcher : IQueryDispatcher<PostEntity>
    {
        ...
        public void RegisterHendler<TQuery>(Func<TQuery, Task<List<PostEntity>>> handler) where TQuery : BaseQuery
        {
        ...
        public async Task<List<PostEntity>> SendAsync(BaseQuery query)
        {
            ...
            throw new ArgumentNullException(nameof(handler), "No query handle was registered!");
        }
    }
}
